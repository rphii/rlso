...
const char _so_at(So_Ref s, size_t i);
const char  so_at0(So s);
const char _so_at0(So_Ref s);
#define     so_it(s, i)         _so_it(so_ref((s)), i)      //(so_is_stack((s)) ? (s).stack.str + (i) : (s).ref.str + (i))
char *     _so_it(So_Ref s, size_t i);
#define     so_it0(s)           _so_it0(so_ref((s)))         //(so_is_stack((s)) ? (s).stack.str : (s).ref.str)
char *     _so_it0(So_Ref s);
#define     so_i0(s, i0)        _so_i0(so_ref((s)), i0)     //so_ll(so_it((s), i0), so_len((s)) - i0)
So         _so_i0(So_Ref s, size_t i0);
#define     so_iE(s, iE)        _so_iE(so_ref((s)), iE)      //so_ll(so_it0((s)), iE)
So         _so_iE(So_Ref s, size_t iE);
#define     so_sub(s, i0, iE)   _so_sub(so_ref((s)), i0, iE) //so_ll(so_it(s, i0), so_len((s)) - (iE - i0))
